pipeline {
    ...
    environment {
        ...
        GITHUB_URL = 'https://github.com/Rohaeb-2/225-lab3-8.git'  // GitHub repository containing Kubernetes YAML files
        KUBECONFIG = credentials('alir2-225')             // Jenkins stored credential for accessing your Kubernetes cluster
    }
